...
export default function EmployeeNavbar() {
    ...
    const initials = username?.trim()?.charAt(0)?.toUpperCase() || "E";
        ...
        <div className="flex items-center justify-between border-b border-gray-200 bg-white px-4 py-2 shadow-sm">
            ...
            <div className="flex items-center gap-6">
                <button
                    ...
                    className="relative rounded-full bg-gray-100 p-4 transition hover:bg-gray-200"
                >
                ...
                <div className="relative" ref={dropdownRef}>
                    <button
                        ...
                        className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-full bg-blue-600 text-lg font-bold text-white shadow-md transition duration-300 hover:bg-blue-700"
                    >
                        {initials}
                    </button>

                    {isOpen && (
                        <div className="absolute right-0 z-[60] mt-3 w-60 rounded-2xl border border-gray-200 bg-white p-4 shadow-xl">
